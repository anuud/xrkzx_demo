    ...
    <AboutHeaderWrapper>
      <div className="w-4/5 m-auto">
        <div className="w-full mt-5">
          ...
          <div className="flex justify-between">
            <div className="flex-1">
              <p className="text-lg indent-8 leading-10 ">
            ...
            <div className="w-[45%]">
              <img
                src={require('../../../../assets/images/abouut/10114157thig.jpg')}
                className="w-[100%]"
              />
            </div>
          </div>
        ...
        <div className="w-full mt-5">
          ...
          <div className="lg:flex justify-between mb-5 mt-2 text-lg">
            <div className="lg:w-1/2 p-5 bg-slate-300 xs:w-[100%]">
              <span className="block text-lg font-bold leading-8 text-center">品牌及价值观：</span>
              <span className="font-black leading-10">对学员有帮助的，就是对的</span>
              <p className="leading-8">
                “做一个有诚信、专业、有品质，受人信赖、受人尊敬的品牌”，这在向日葵择校，是最核心的价值观。
              </p>
              <p className="leading-8">
                珍惜品牌声誉，倾听每一位学员的声音，包括学员的赞誉和抱怨，用心为学员设计、规划最适合的学习方案。在向日葵择校，我们常常要求员工假设：如果我是学生或家长，我希望得到什么样的咨询服务和帮助？
              </p>
            </div>
            <div className="lg:w-1/2 p-5 bg-slate-300 lg:ml-1 leading-6 xs:w-[100%]">
              <p className="block text-lg font-bold leading-8 text-center">产品及服务：</p>
              <p className="font-black leading-10"> 如果您有不满意 那一定是我们做的还不够好</p>
              <p className="leading-8">
